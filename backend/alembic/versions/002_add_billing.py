...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("conversions_used", sa.BigInteger(), nullable=False, server_default="0"))
    op.add_column("users", sa.Column("conversions_limit", sa.BigInteger(), nullable=False, server_default="5"))
    op.add_column("users", sa.Column("storage_used", sa.BigInteger(), nullable=False, server_default="0"))
    op.add_column("users", sa.Column("storage_limit", sa.BigInteger(), nullable=False, server_default="52428800"))
    op.add_column("users", sa.Column("priority_processing", sa.Boolean(), nullable=False, server_default="false"))
