...
def upgrade() -> None:
    ...
    op.create_index("ix_activity_events_user", "activity_events", ["user_id", sa.text("created_at DESC")])
    op.create_index("ix_activity_events_project", "activity_events", ["project_id", sa.text("created_at DESC")])
