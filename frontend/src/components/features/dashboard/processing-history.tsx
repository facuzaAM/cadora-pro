...
function projectToHistory(p: Project): HistoryItem {
  const typeMap: Record<string, HistoryItem["type"]> = {
    ...
    detection_running: "processing",
    detection_processing: "processing",
  ...
  const descMap: Record<string, string> = {
    ...
    detection_running: "Procesando detección del plano",
    detection_processing: "Procesando detección del plano",
