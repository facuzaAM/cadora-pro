  ...
  return (
    <div className="flex min-h-screen flex-col">
      <StructuredData data={{
        ...
        operatingSystem: "Web",
        description: "Convierte planos arquitectónicos en PDF, PNG, JPG, JPEG y TIFF a archivos DXF/DWG editables con detección automática de muros, puertas, ventanas y textos.",
